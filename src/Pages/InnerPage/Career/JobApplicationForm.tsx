...
// Helper function for generating IDs (replacement for glbId)
const glbId = (...args: string[]) => args.join("-");
...
const JobApplicationFormPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = `${
      language === "en" ? "Job Application Form" : "जागिर आवेदन फारम"
    } - Gurans Laghubitta`;
  }, [language]);
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6" id={glbId("career", "form", "personal")}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Name (Nepali)" : "नाम (नेपाली)"}{" "}
                  *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Father's Name" : "बुवाको नाम"} *
                </label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Mother's Name" : "आमाको नाम"} *
                </label>
                <input
                  type="text"
                  required
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Mother Language" : "मातृभाषा"} *
                </label>
                <input
                  type="text"
                  required
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Mobile Number" : "मोबाइल नम्बर"}{" "}
                  *
                </label>
                <input
                  type="text"
              ...
              <div className="col-span-2">
                <h4 className="text-lg font-semibold text-gray-800 mb-2">
                  {language === "en" ? "Recent Address" : "हालको ठेगाना"}
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            {formData.training.map((training, index) => (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      {language === "en" ? "Institution" : "संस्था"} *
                    </label>
                    <input
                      type="text"
                      required
      ...
      case 5:
        return (
          <div className="space-y-6" id={glbId("career", "form", "job")}>
            <h3 className="text-xl font-bold text-gray-900 mb-4">
              {language === "en" ? "Job Information" : "जागिरको जानकारी"}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Desired Position" : "चाहिएको पद"}{" "}
                  *
                </label>
                <input
                  type="text"
      ...
      case 7:
        return (
          <div className="space-y-6" id={glbId("career", "form", "experience")}>
            <h3 className="text-xl font-bold text-gray-900 mb-4">
              {language === "en" ? "Work Experience" : "कार्य अनुभव"}
            </h3>
      ...
      case 8:
        return (
          <div className="space-y-6" id={glbId("career", "form", "documents")}>
            <h3 className="text-xl font-bold text-gray-900 mb-4">
              {language === "en" ? "Document Upload" : "कागजात अपलोड"}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Resume/CV */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Resume/CV" : "बायोडाटा"} *
                </label>
                <input
                  type="file"
                  required
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Cover Letter" : "कभर लेटर"}
                </label>
                <input
                  type="file"
                  accept=".pdf,.doc,.docx"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {language === "en" ? "Signature Date" : "हस्ताक्षर मिति"} *
                </label>
                <input
                  type="date"
                  required
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <section
        className="bg-gradient-to-r from-glb-primary-600 to-glb-secondary-600 text-black py-20"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-sm text-gray-600">
              {language === "en" ? "Step" : "चरण"} {currentStep}{" "}
              {language === "en" ? "of" : "को"} {totalSteps}
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Form Content */}
      <section className="py-8" id={glbId("career", "form", "content")}>
        <div className="container mx-auto px-4">
