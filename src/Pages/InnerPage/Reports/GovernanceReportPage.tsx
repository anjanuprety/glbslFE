...
const GovernanceReportPage: React.FC = () => {
  const [pdfUrl] = useState("/documents/governance-report-sample.pdf");

  const handleDownload = () => {
    const link = document.createElement('a');
    link.href = pdfUrl;
    link.download = 'Governance-Report-2023.pdf';
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Governance Report 2023 - Gurans Laghubitta',
          text: 'Corporate governance and compliance report',
  ...
  return (
    <section className="">
      <BreadCrumb title="GOVERNANCE REPORT" home={"/"} />
            ...
            <div>
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-whiteSmoke dark:bg-lightBlack h-12 lg:h-[56px] grid items-center justify-start px-4">
                    <p className="text-sm md:text-[15px] leading-[26px] font-Lora font-medium text-lightBlack dark:text-white">
                      Published Date: <span className="text-khaki">February 20, 2024</span>
                    </p>
                  </div>
                  <div className="bg-whiteSmoke dark:bg-lightBlack h-12 lg:h-[56px] grid items-center justify-start px-4">
                    <p className="text-sm md:text-[15px] leading-[26px] font-Lora font-medium text-lightBlack dark:text-white">
                      File Size: <span className="text-khaki">4.2 MB</span>
                    </p>
                  </div>
                  <div className="bg-whiteSmoke dark:bg-lightBlack h-12 lg:h-[56px] grid items-center justify-start px-4">
                    <p className="text-sm md:text-[15px] leading-[26px] font-Lora font-medium text-lightBlack dark:text-white">
                      Pages: <span className="text-khaki">45</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm lg:text-base leading-6 text-gray dark:text-lightGray font-normal font-Lora">
                    Comprehensive corporate governance report detailing our compliance framework, board effectiveness, risk management practices, and regulatory adherence. This report demonstrates our commitment to transparency and ethical business practices.
                  </p>
                </div>
